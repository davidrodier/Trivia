...
ALTER TABLE SCORE ADD CONSTRAINT FK_CODE_SCORE FOREIGN KEY(CODECATEGORIE) REFERENCES CATEGORIE(CODECAT); 
ALTER TABLE SCORE ADD CONSTRAINT FK_PSEUDO_SCORE FOREIGN KEY(PSEUDO) REFERENCES JOUEUR(PSEUDO);
ALTER TABLE SCORE ADD CONSTRAINT PK_SCORE PRIMARY KEY(CODECATEGORIE, PSEUDO);
...
FUNCTION SELECTSCOREFROMJOUEUR (SCORE IN NUMBER, IN_PSEUDO IN VARCHAR2, IN_CODECATEGORIE IN CHAR(3) ) RETURN SYS_REFCURSOR;
...
FUNCTION SELECTSCOREFROMJOUEUR (SCORE IN NUMBER, IN_PSEUDO IN VARCHAR2, IN_CODECATEGORIE IN CHAR(3) ) RETURN SYS_REFCURSOR AS
RESULTAT SYS_REFCURSOR;
BEGIN
